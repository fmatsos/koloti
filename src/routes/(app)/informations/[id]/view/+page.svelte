...
<style>
	...
	.meta { font-size: 0.8125rem; color: var(--color-text-muted, #6b7280); margin-top: 0.25rem; }
	.badge-draft { display: inline-block; background: #fef9c3; color: #854d0e; font-size: 0.75rem; padding: 0.1rem 0.5rem; border-radius: 9999px; margin-left: 0.5rem; }
	...
	.prose :global(pre) { background: #f3f4f6; border-radius: 0.25rem; padding: 0.75rem; overflow-x: auto; font-size: 0.875rem; }
</style>
