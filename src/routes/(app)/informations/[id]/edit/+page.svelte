...
<svelte:head><title>Modifier {post.title} — Koloti</title></svelte:head>

<div class="page-header">
	<a href="/informations/{post.id}/view" class="back-link">← Vue de l'information</a>
	<h1>Modifier le post</h1>
</div>

{#if form?.success}<div class="alert-success">Post mis à jour.</div>{/if}
