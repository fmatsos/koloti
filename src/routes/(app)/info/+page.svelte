...
<style>
	...
	h2 { margin: 0 0 0.25rem; font-size: 1.125rem; }
	.meta { font-size: 0.8125rem; color: var(--color-text-muted, #6b7280); }
	.author { margin-left: 0.25rem; }
	.prose { font-size: 0.9375rem; line-height: 1.6; color: var(--color-text, #111827); }
	.prose :global(h1), .prose :global(h2), .prose :global(h3) { margin: 1rem 0 0.5rem; font-size: 1rem; }
	.prose :global(p) { margin: 0 0 0.75rem; }
	.prose :global(ul), .prose :global(ol) { margin: 0 0 0.75rem; padding-left: 1.5rem; }
	.prose :global(blockquote) { border-left: 3px solid var(--color-border, #e5e7eb); margin: 0 0 0.75rem; padding: 0.25rem 0 0.25rem 1rem; color: var(--color-text-muted, #6b7280); }
	.prose :global(pre) { background: #f3f4f6; border-radius: 0.25rem; padding: 0.75rem; overflow-x: auto; font-size: 0.875rem; margin: 0 0 0.75rem; }
	.prose :global(code) { background: #f3f4f6; padding: 0.1rem 0.3rem; border-radius: 0.2rem; font-size: 0.875rem; }
	.prose :global(a) { color: var(--color-primary, #1a73e8); }
</style>
