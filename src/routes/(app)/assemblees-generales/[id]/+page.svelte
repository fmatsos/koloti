...
<div class="detail-grid">
	<div class="card">
		<h2>Paramètres</h2>
		{#if data.isAdminOrEditor && ag.status === 'draft'}
	...
	{#if data.isAdminOrEditor}
		<div class="card">
			...
			<div class="action-list">
				<a href="/assemblees-generales/{ag.id}/agenda" class="btn-action">Ordre du jour →</a>

				{#if ag.status === 'draft'}
					<a href="/assemblees-generales/{ag.id}/convoquer" class="btn-action">Convoquer l'AG →</a>
				{/if}
