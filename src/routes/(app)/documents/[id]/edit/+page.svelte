...
<svelte:head><title>Modifier {doc.title} — Koloti</title></svelte:head>
...
{#if form?.success}<div class="alert-success">Visibilité mise à jour.</div>{/if}
