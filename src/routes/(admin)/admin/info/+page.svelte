			...
			<tbody>
				{#each data.posts as post}
					...
					<tr>
						...
						<td class="muted">{post.published_at ? new Date(post.published_at).toLocaleDateString('fr-FR') : new Date(post.created_at).toLocaleDateString('fr-FR')}</td>
...
<style>
	...
	.badge-pub { display: inline-block; background: #dcfce7; color: #15803d; font-size: 0.75rem; padding: 0.1rem 0.5rem; border-radius: 9999px; }
