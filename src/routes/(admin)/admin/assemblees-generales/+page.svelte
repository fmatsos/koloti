...
<svelte:head><title>Assemblées générales — Admin — Koloti</title></svelte:head>

<div class="page-header">
	<div class="header-row">
		<h1>Assemblées générales</h1>
		<a href="/admin/assemblees-generales/new" class="btn-sm">+ Nouvelle AG</a>
	</div>
</div>

<div class="card">
	{#if data.assemblies.length === 0}
		<p class="empty">Aucune assemblée.</p>
	{:else}
		<table>
			<thead>
				<tr>
			...
			<tbody>
				{#each data.assemblies as ag (ag.id)}
					<tr>
						...
						<td><a href="/admin/assemblees-generales/{ag.id}" class="link-sm">Gérer</a></td>
					</tr>
				{/each}
			</tbody>
		</table>
