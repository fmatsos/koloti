...
<div class="page-header">
	<a href="/admin/assemblees-generales" class="back-link">← Assemblées</a>
...
<div class="detail-grid">
	...
	<div class="card">
		...
		<div class="action-list">
			<a href="/admin/assemblees-generales/{ag.id}/agenda" class="btn-action">Ordre du jour →</a>

			{#if ag.status === 'draft'}
				<a href="/admin/assemblees-generales/{ag.id}/convoquer" class="btn-action">Convoquer l'AG →</a>
			{/if}
			...
			{#if ag.status === 'convened'}
				...
				<a href="/admin/assemblees-generales/{ag.id}/relancer" class="btn-action">Relancer comptes pending →</a>
			{/if}

			{#if ag.status === 'open'}
				<a href="/admin/assemblees-generales/{ag.id}/emargement" class="btn-action">Émargement →</a>
				<a href="/admin/assemblees-generales/{ag.id}/quorum" class="btn-action">Quorum →</a>
			{/if}
		</div>
	</div>
</div>
