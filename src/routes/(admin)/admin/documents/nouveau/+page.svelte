...
<svelte:head><title>Nouveau document — Koloti</title></svelte:head>
...
<div class="form-card">
	<form method="POST" enctype="multipart/form-data">
		<div class="field">
			<label for="file">Fichier * <span class="hint">(max 20 Mo)</span></label>
		...
		<div class="field">
			...
			<select id="visibility" name="visibility">
				...
				<option value="editors">Éditeurs et admins</option>
				<option value="admin">Admins uniquement</option>
			</select>
		</div>
		<div class="field">
			<label for="year">Année</label>
			<input id="year" name="year" type="number" min="2000" max="2100" placeholder="ex. 2024" />
		</div>
		<div class="field">
		...
		<div class="form-actions">
			<a href="/admin/documents" class="btn-secondary">Annuler</a>
...
<style>
	...
	.hint { font-size: 0.75rem; font-weight: 400; color: var(--color-text-muted, #6b7280); }
	input[type="text"], input[type="number"], select, textarea { width: 100%; padding: 0.5rem 0.75rem; border: 1px solid var(--color-border, #e5e7eb); border-radius: var(--radius, 0.375rem); font-size: 0.9375rem; box-sizing: border-box; }
