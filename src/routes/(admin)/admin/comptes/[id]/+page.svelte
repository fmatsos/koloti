...
<svelte:head>
	<title>{compte.full_name} — Administration Koloti</title>
</svelte:head>
...
<div class="detail-grid">
	...
	<div class="card">
		...
		<dl class="info-list">
			...
			<dt>Créé le</dt>
			<dd>{formatDate(compte.created_at)}</dd>
			<dt>Activé le</dt>
			<dd>{formatDate(compte.activated_at)}</dd>
			<dt>Dernière connexion</dt>
			<dd>{formatDate(compte.last_login_at)}</dd>
		</dl>
	</div>
