...
('i0000000-0000-0000-0001-000000000001', 'c0000000-0000-0000-0000-000000000001',
 'a0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001',
 'present', '2022-06-15 18:15:00+00'),
('i0000000-0000-0000-0001-000000000002', 'c0000000-0000-0000-0000-000000000001',
 'a0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000002',
 'present', '2022-06-15 18:12:00+00'),
-- François Petit was still owner of LOT-03 in June 2022
('i0000000-0000-0000-0001-000000000003', 'c0000000-0000-0000-0000-000000000001',
 'a0000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000003',
 'present', '2022-06-15 18:08:00+00'),
('i0000000-0000-0000-0001-000000000004', 'c0000000-0000-0000-0000-000000000001',
 'a0000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000004',
 'present', '2022-06-15 18:20:00+00'),
-- Nathalie Simon sent a representative
('i0000000-0000-0000-0001-000000000005', 'c0000000-0000-0000-0000-000000000001',
 'a0000000-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000006',
 'represented', '2022-06-15 18:10:00+00'),
-- Chantal Dubois was absent
('i0000000-0000-0000-0001-000000000006', 'c0000000-0000-0000-0000-000000000001',
 'a0000000-0000-0000-0000-000000000010', 'b0000000-0000-0000-0000-000000000008',
 'absent', '2022-06-15 18:30:00+00');

-- AG 2023 (closed)
insert into public.attendance (id, assembly_id, profile_id, property_id, mode, recorded_at) values
('i0000000-0000-0000-0002-000000000001', 'c0000000-0000-0000-0000-000000000002',
 'a0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001',
 'present', '2023-06-20 18:45:00+00'),
('i0000000-0000-0000-0002-000000000002', 'c0000000-0000-0000-0000-000000000002',
 'a0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000002',
 'present', '2023-06-20 18:42:00+00'),
-- Ahmed Benali is now owner of LOT-03 (transferred June 2023)
('i0000000-0000-0000-0002-000000000003', 'c0000000-0000-0000-0000-000000000002',
 'a0000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000003',
 'present', '2023-06-20 18:50:00+00'),
-- Isabelle sent a representative
('i0000000-0000-0000-0002-000000000004', 'c0000000-0000-0000-0000-000000000002',
 'a0000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000004',
 'represented', '2023-06-20 18:40:00+00'),
-- François now attends on his new lot (LOT-05)
('i0000000-0000-0000-0002-000000000005', 'c0000000-0000-0000-0000-000000000002',
 'a0000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000005',
 'present', '2023-06-20 18:48:00+00'),
('i0000000-0000-0000-0002-000000000006', 'c0000000-0000-0000-0000-000000000002',
 'a0000000-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000006',
 'present', '2023-06-20 18:44:00+00'),
-- Chantal absent again
('i0000000-0000-0000-0002-000000000007', 'c0000000-0000-0000-0000-000000000002',
 'a0000000-0000-0000-0000-000000000010', 'b0000000-0000-0000-0000-000000000008',
 'absent', '2023-06-20 19:00:00+00');

-- AG Extraordinaire 2024 (open — partial, meeting still in progress)
insert into public.attendance (id, assembly_id, profile_id, property_id, mode, recorded_at) values
('i0000000-0000-0000-0003-000000000001', 'c0000000-0000-0000-0000-000000000003',
 'a0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001',
 'present', '2024-03-15 19:15:00+00'),
('i0000000-0000-0000-0003-000000000002', 'c0000000-0000-0000-0000-000000000003',
 'a0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000002',
 'present', '2024-03-15 19:12:00+00'),
('i0000000-0000-0000-0003-000000000003', 'c0000000-0000-0000-0000-000000000003',
 'a0000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000003',
 'present', '2024-03-15 19:10:00+00'),
-- François represented (couldn't attend in person)
('i0000000-0000-0000-0003-000000000004', 'c0000000-0000-0000-0000-000000000003',
 'a0000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000005',
...
('j0000000-0000-0000-0000-000000000007',
...
('k0000000-0000-0000-0001-000000000001',
 'k0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001',
 450.00, 'paid', '2024-03-15'),
('k0000000-0000-0000-0001-000000000002',
 'k0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002',
 450.00, 'paid', '2024-02-28'),
-- LOT-03 has vote_weight=2 → double contribution
('k0000000-0000-0000-0001-000000000003',
 'k0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000003',
 900.00, 'paid', '2024-04-01'),
-- Isabelle paid partially
('k0000000-0000-0000-0001-000000000004',
 'k0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000004',
 450.00, 'partial', null),
('k0000000-0000-0000-0001-000000000005',
 'k0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000005',
 450.00, 'paid', '2024-03-20'),
-- Nathalie is overdue
('k0000000-0000-0000-0001-000000000006',
 'k0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000006',
 450.00, 'overdue', null),
-- Thomas (pending) — not yet paid
('k0000000-0000-0000-0001-000000000007',
 'k0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000007',
 450.00, 'due', null),
-- LOT-08 unowned — still due
('k0000000-0000-0000-0001-000000000008',
 'k0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000008',
 450.00, 'due', null);
...
(gen_random_uuid(),
 'a0000000-0000-0000-0000-000000000001',
 'ownership.transfer', 'ownership', 'g0000000-0000-0000-0000-000000000004',
